...
# MCP server global
mcp = FastMCP(name="OpenLibrary Assistant")
...
def search_books(query: str) -> list:
    ...
    Returns a list of dictionaries: title, author, year, work_id.
    """
...
def get_book_details(work_id: str) -> dict:
    """
    Retrieve details about a specific book using its OpenLibrary work ID.
    Example work_id: "/works/OL82563W" or "OL82563W"
    """
